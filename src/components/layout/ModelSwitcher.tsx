...
export default function ModelSwitcher() {
  const { settings, loadSettingsFromStorage, setDefaultProvider, isModelSwitcherOpen, toggleModelSwitcher, closeModelSwitcher } =
    useSettingsStore();
      ...
      {isModelSwitcherOpen && (
        ...
        >
          ...
          <div className="px-3 py-2 border-t border-[var(--scout-border)]">
            <p className="text-[10px] text-[var(--scout-text-muted)]">
              Applies to new enrichments. Override per-company in the enrichment panel.
            </p>
          </div>
        </div>
      )}
